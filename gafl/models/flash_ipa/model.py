...
from gafl.models.flash_ipa.edge_embedder import EdgeEmbedder, EdgeEmbedderConfig
from gafl.models.flash_ipa.ipa import StructureModuleTransition, BackboneUpdate, EdgeTransition, InvariantPointAttention, IPAConfig
from gafl.models.flash_ipa.utils import ANG_TO_NM_SCALE, NM_TO_ANG_SCALE, check_config_ipa
from gafl.models.flash_ipa.rigid import create_rigid
from gafl.models.flash_ipa.linear import Linear
...
class Model(nn.Module):
    ...
    def forward(self, input_feats):
        ...
        translations = trans_t
        rotations = rotmats_t
        
        init_edge_embed = None # Edge embedder computes it if needed
        ...
        edge_embed, z_factor_1, z_factor_2, edge_mask = self.edge_embedder(
            ...
            node_mask,
            init_edge_embed,
            None, # edge_mask inferred if None
        )
